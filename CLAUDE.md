...
- **Логотип** ([favicon.svg](src/frontend/ui.public.web/wwwroot/favicon.svg)) — силуэт Кольского полуострова в аврора-градиенте (тот же path, что на карте) с жёлтой точкой Мурманска; используется и как favicon, и как brand-mark в шапке/футере.
